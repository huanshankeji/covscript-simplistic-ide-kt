...
inline fun <T> toEnglishStringWithNullForDefault(
    default: String,
    value: T?,
    notNullToString: (T) -> String
) =
    if (value === null) "default: $default" else notNullToString(
        value
    )
...
inline fun <T> toEnglishStringWithNullForDefault(
    ...
    toEnglishStringWithNullForDefault(
        notNullToString(
            default
        ), value, notNullToString
    )

inline fun <T> toEnglishStringOnlyConverterWithNullForDefault(
    default: String,
    crossinline notNullToString: (T) -> String
) =
