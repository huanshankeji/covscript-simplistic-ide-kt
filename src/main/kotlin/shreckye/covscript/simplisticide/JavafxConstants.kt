...
val CS_PACKAGE_FILE_EXTENSION_FILTER = FileChooser.ExtensionFilter("CovScript package file", "*.csp")
...
val AST_FILE_FILTERS = arrayOf(
    FileChooser.ExtensionFilter("CovScript AST file", "*.csa")
)

val EXTENSION_FILE_FILTERS = arrayOf(
    FileChooser.ExtensionFilter("CovScript extension", "*.cse"),
